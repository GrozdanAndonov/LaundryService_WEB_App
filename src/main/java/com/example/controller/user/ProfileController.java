...
@RequestMapping(value="uploadPicture", method=RequestMethod.POST)
	...
	public static String copyFile(User user, MultipartFile file, String filePath, String extension, Model model) throws IllegalStateException, IOException {
	...
	public static boolean checkIfExtensionForFileisAllowed(String extension) {
	...
	public static String getExtensionForFile(MultipartFile file) {
		MimeType type = null;
		try {
	...
	public static void addAtributesInModel(User user, Model model) {
