...
<title>Unchecked Express Orders list</title>
<meta
		...
		<div class="container">
			<div class="row">
				<div class="col-md-8 ml-auto mr-auto">
					<div class="brand">
						<h1>Unchecked Express Orders list</h1>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="section section-basic">
			<div class="container">
				<div class="title text-center">
					<h2>Unchecked Express orders</h2>
							...
							<c:forEach items="${ orders }" var="order">
								<tr>
									...
									<td class="td-actions text-right"><a
										href="/LaundryService/uncheckedExpressOrderDetails/${ order.id }"><button
				...
				<c:otherwise>
					<div class="title text-center">
						<h3>No unchecked express orders found.</h3>
					</div>
				</c:otherwise>
				</c:choose>
					<div class="col-md-12">
			  		<a href="/LaundryService/viewExpressOrders">
