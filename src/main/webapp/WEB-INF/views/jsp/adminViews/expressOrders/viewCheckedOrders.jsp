...
<title>Checked express orders list</title>
<meta
		...
		<div class="container">
			<div class="row">
				<div class="col-md-8 ml-auto mr-auto">
					<div class="brand">
						<h1>Checked express orders list</h1>
					</div>
				</div>
			</div>
		</div>
							...
							<c:forEach items="${ orders }" var="order">
								<tr>
									...
									<td class="td-actions text-right"><a
										href="/LaundryService/checkedExpressOrderDetails/${ order.id }"><button
