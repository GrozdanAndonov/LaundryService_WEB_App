    ...
    <c:forEach items="${ orders }" var="order">
        <tr>
            ...
            <td class="td-actions text-right">
                ...
                <button type="button" rel="tooltip" title="Edit Profile" class="btn btn-success btn-simple btn-xs btn-link">
                    <i class="fa fa-edit"></i>
                </button>
                <button type="button" rel="tooltip" title="Remove" class="btn btn-danger btn-simple btn-xs btn-link">
